...
class YaadiLeadHome extends StatefulWidget {
  static const String routeName = 'yaadi_lead_screen';

  const YaadiLeadHome({super.key});

  @override
  State<YaadiLeadHome> createState() => _YaadiLeadHomeState();
}

class _YaadiLeadHomeState extends State<YaadiLeadHome> {
  @override
  void initState() {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: pr.voterData.totalVoters != 0
                              ? PieChart(
                                  PieChartData(
                                    sections: [
                                      PieChartSectionData(
